...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="bg-card border-b border-border">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex space-x-8 py-3">
            <a
              href="#home"
              className="text-foreground hover:text-primary font-medium py-2 border-b-2 border-primary"
            >
              HOME
            </a>
            <a
      ...
      <section
        id="home"
        className="bg-gradient-to-b from-blue-500 to-blue-700 text-white py-16"
      >
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-gradient-to-b from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white font-bold px-8 py-3 rounded shadow-lg cursor-pointer"
                  onClick={() => (window.location.href = "/estimate")}
                >
                  GET FREE ESTIMATE
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  className="bg-white text-blue-600 border-2 border-white font-bold px-8 py-3 rounded shadow-lg hover:bg-gray-100 cursor-pointer"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="shadow-md hover:shadow-lg transition-shadow bg-white">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Wiring, outlets, lighting, panel upgrades, and home automation
                </p>
              </CardContent>
            </Card>
            <Card className="shadow-md hover:shadow-lg transition-shadow bg-white">
            ...
            <Card className="shadow-md hover:shadow-lg transition-shadow bg-white">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Troubleshooting, emergency repairs, and electrical maintenance
                </p>
              </CardContent>
            </Card>
            <Card className="shadow-md hover:shadow-lg transition-shadow bg-white">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Code compliance, safety audits, and electrical system
                  evaluations
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="shadow-md bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-2">Bardstown Road</p>
                <p className="text-muted-foreground mb-2">
                  Louisville, KY 40205
                </p>
                <p className="text-primary font-semibold">(502) 518-7804</p>
              </CardContent>
            </Card>
            <Card className="shadow-md bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-2">New Circle Road</p>
                <p className="text-muted-foreground mb-2">
                  Lexington, KY 40505
                </p>
                <p className="text-primary font-semibold">(502) 518-7804</p>
            ...
            <Card className="shadow-md bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-2">Madison Avenue</p>
                <p className="text-muted-foreground mb-2">
            ...
            <Card className="shadow-md bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-2">Lincoln Avenue</p>
                <p className="text-muted-foreground mb-2">
                  Evansville, IN 47714
                </p>
                <p className="text-primary font-semibold">(502) 518-7804</p>
            ...
            <Card className="shadow-md bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-2">Reading Road</p>
                <p className="text-muted-foreground mb-2">
                  Cincinnati, OH 45229
                </p>
                <p className="text-primary font-semibold">(502) 518-7804</p>
            ...
            <Card className="shadow-md bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-2">West End Avenue</p>
                <p className="text-muted-foreground mb-2">
                  Nashville, TN 37203
                </p>
                <p className="text-primary font-semibold">(502) 518-7804</p>
      ...
      <section id="contact" className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Button
            size="lg"
            className="bg-gradient-to-b from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white font-bold px-12 py-4 text-lg rounded shadow-lg cursor-pointer"
            onClick={() => (window.location.href = "/estimate")}
          >
